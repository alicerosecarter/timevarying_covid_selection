...
Alice R. Carter - 24/06/2021
This script codes up cases according to ICD9 and ICD10 code from the HES released data (cleaned in "cleaning_hes_data.do"). This data was released on the 17/06/2021 and cleaned on the 24/06/2021. Diagnoses dervied here are the same as those in the main data set 
...
save "hes_diagnoses_ICD10_202106", replace
*/
use "hes_diagnoses_ICD10_202106", clear
...
save "hes_diagnoses_202106.dta", replace
