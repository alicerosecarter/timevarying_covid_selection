...
cd "$dataDir/2021-02-24/data/covid"

********************************************************************************
*The diag file needs some mods
import delim "hesin-20210617.txt", clear
sort eid ins_index

save "$resDir/data/ukb_hesin_clean_202106.dta", replace

********************************************************************************
*Diagnoses data
import delim "hesin_diag-20210617.txt", clear
...
save  "$resDir/data/ukb_hesin_diag_clean_202106.dta", replace

********************************************************************************
*Critical care data
import delim "hesin_critical-20210617.txt", clear
sort eid ins_index arr_index
...
save  "$resDir/data/ukb_hesin_critical_clean_202106.dta", replace

********************************************************************************
cd "$resDir/data"
*Combine
use "ukb_hesin_clean_202106.dta", clear
merge 1:1 eid ins_index using "ukb_hesin_diag_clean_202106.dta", nogen
merge 1:1 eid ins_index using "ukb_hesin_critical_clean_202106.dta"
